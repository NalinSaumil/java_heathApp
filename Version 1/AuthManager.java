...
class AuthManager {
   ...
   public AuthManager() {
      ...
      users.add(new User("user1", "password1", "one", "Male", 160.2, 24, 75));
      users.add(new User("user2", "password2", "two", "Female", 120.5, 23, 68));
   ...
   public boolean addUser(String username, String password, String name, String gender, double weight, int age, double height) {
   ...
   public boolean updateUser(String username, String realName, double height, double weight, int age, String gender) {
      for (User user : users) {
         if (user.getUsername().equals(username)) {
